...
confusion_matrix_display = ConfusionMatrixDisplay.from_estimator(pipe, X_test, y_test)
confusion_matrix_display.plot(cmap=plt.cm.Blues)
plt.title("Confusion Matrix")
plt.xlabel("Predicted Labels")
plt.ylabel("True Labels")
plt.savefig("/home/sarass/Documents/Proj1/Microservices/code_model_training/confusion_matrix.png")
